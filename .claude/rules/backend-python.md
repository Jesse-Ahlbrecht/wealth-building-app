...
- Routes live in `backend/routes/`; register blueprints in `app.py`
- All DB access through `database.py`
- Auth middleware in `backend/middleware/` — do not bypass for user data routes
